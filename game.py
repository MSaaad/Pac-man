...
class Game(object):
    def __init__(self):
        ...
        self.menu = Menu(("PLAY!","CREDITS","QUIT?"),font_color = GREY,font_size=60)
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            ...
            text = self.font.render("Score!: " + str(self.score),True,COLOR)
...
class Menu(object):
    state = 0
    def __init__(self,items,font_color=(0,0,0),select_color=(255,0,0),ttf_font='georgia',font_size=20):
        self.font_color = font_color
        self.select_color = select_color
        self.items = items
        self.font = pygame.font.SysFont(ttf_font,font_size)
